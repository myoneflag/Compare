...
(function(AJAX, HUB, HTML, PHTML) {
    ...
    var STYLES = {
        ...
        ".MJXp-scr": {
            "font-family": "MathJax_Script," + FONTS
        },
        ".MJXp-frak": {
            "font-family": "MathJax_Fraktur," + FONTS
        },
        ".MJXp-sf": {
            "font-family": "MathJax_SansSerif," + FONTS
        },
        ".MJXp-cal": {
            "font-family": "MathJax_Caligraphic," + FONTS
        },
        ".MJXp-mono": {
            "font-family": "MathJax_Typewriter," + FONTS
        },
        ".MJXp-largeop": {
            "font-size": "150%"
        },
        ...
        ".MJXp-box:after": {
            "content": '" "'
        }, // needed for when there is no DOCTYPE
        ".MJXp-rule": {
            "display": "block!important",
            "margin-top": ".1em"
        },
                            ...
                            [
                                ["span", {},
                                    [
                                        ["span", {
                                            style: {
                                                "margin-bottom": PHTML.Em(-(sup.PHTML.d - .05))
                                            }
                                        }]
                                    ]
                                ]
                            ...
                            [
                                ["span", {},
                                    [
                                        ["span", {
                                            style: {
                                                "margin-top": PHTML.Em(-(sup.PHTML.h - .05))
                                            }
                                        }]
                                    ]
                                ]
