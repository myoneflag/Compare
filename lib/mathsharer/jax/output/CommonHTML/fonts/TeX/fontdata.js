...
(function(CHTML, MML, AJAX) {
    ...
    CHTML.FONTDEF.TeX = {
        ...
        VARIANT: {
            ...
            "-TeX-vec": {
                ...
                cache: {}
            }, // HACK: non-combining \vec
            "-TeX-vec-bold": {
                fonts: ["MathJax_Vector-Bold"],
                cache: {}
            }, // HACK: non-combining \vec
            "-largeOp": {
                fonts: [SIZE2, SIZE1, MAIN, AMS],
                cache: {}
            },
            "-smallOp": {
                fonts: [SIZE1, MAIN, AMS],
                cache: {}
            },
        ...
        DELIMITERS: {
            ...
            0x20D7: {
                alias: 0x2192,
                dir: H
            }, // combining over right arrow (vector arrow)
            0x2215: {
                alias: 0x002F,
                dir: V
            }, // division slash
    ...
    CHTML.FONTDATA.FONTS['MathJax_Main-Bold'] = {
        ...
        Extra: [
            ...
            0x131, 0x237, [0x2C6, 0x2CB],
            [0x2D8, 0x2DC],
            [0x300, 0x30C], 0x338, [0x2002, 0x2006], 0x2009, 0x200A, 0x2013, 0x2014, 0x2018, 0x2019,
            0x201C, 0x201D, 0x2020, 0x2021, 0x2026, 0x2032,
            0x20D7, [0x210F, 0x2113], 0x2118, 0x211C, 0x2135, [0x2190, 0x2199], 0x21A6, 0x21A9, 0x21AA, 0x21BC, 0x21BD, 0x21C0,
            ...
            [0x22A2, 0x22A5], 0x22A8, [0x22C4, 0x22C8],
            [0x22EE, 0x22F1],
            [0x2308, 0x230B], 0x2322, 0x2323,
            0x25B3, 0x25B9, 0x25BD, 0x25C3, 0x25EF, [0x2660, 0x2663],
            [0x266D, 0x266F],
            0x27E8, 0x27E9, [0x27F5, 0x27FC],
    ...
    CHTML.FONTDATA.FONTS[MAIN][0x2245][5] = {
        rfix: -222
    }; // fix error in character's right bearing
    MathJax.Hub.Register.LoadHook(CHTML.fontDir + "/TeX/Main-Bold.js", function() {
        ...
        CHTML.FONTDATA.FONTS[BOLD][0x2245][5] = {
            rfix: -106
        }; // fix error in character's right bearing
    });
    MathJax.Hub.Register.LoadHook(CHTML.fontDir + "/TeX/Typewriter-Regular.js", function() {
        ...
        CHTML.FONTDATA.FONTS['MathJax_Typewriter'][0x20][5] = {
            rfix: 275
        }; // fix error in character width
        CHTML.FONTDATA.FONTS['MathJax_Typewriter'][0xA0][2] += 275; // fix error in character width
        CHTML.FONTDATA.FONTS['MathJax_Typewriter'][0xA0][5] = {
            rfix: 275
        }; // fix error in character width
    });
