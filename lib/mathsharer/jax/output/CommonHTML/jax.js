...
(function(AJAX, HUB, HTML, CHTML) {
    ...
    var STRUTHEIGHT = 1,
        ...
        HFUZZ = .025,
        DFUZZ = .025; // adjustments to bounding box of character boxes
    ...
    CHTML.Augment({
        ...
        Startup: function() {
            ...
            //
            this.TestSpan = CHTML.Element("mjx-test", {
                style: {
                    left: "1em"
                }
            }, [
        ...
        fontLoaded: function(font) {
            ...
            MathJax.Callback.Queue(
                ["Post", HUB.Startup.signal, "CommonHTML - font data loaded for " + font], ["loadComplete", AJAX, this.fontDir + "/" + font]
            );
        },
        ...
        Zoom: function(jax, span, math, Mw, Mh) {
            ...
            var node = CHTML.addElement(span, "mjx-chtml", {
                style: {
                    "font-size": Math.floor(CHTML.scale * 100) + "%"
                },
                isMathJax: false
            });
        ...
        styledText: function(variant, text) {
            ...
            if (!this.STYLEDTEXT[id]) this.STYLEDTEXT[id] = {
        ...
        getHDW: function(c, name, styles) {
            var test1 = CHTML.addElement(CHTML.CHTMLnode, "mjx-chartest", {
                className: name
            }, [
                ["mjx-char", {
                        style: styles
            ...
            var test2 = CHTML.addElement(CHTML.CHTMLnode, "mjx-chartest", {
                className: name
            }, [
                ["mjx-char", {
                        style: styles
    ...
    MathJax.Hub.Register.StartupHook("mml Jax Ready", function() {
        ...
        MML.mbase.Augment({
            ...
            CHTMLcreateNode: function(node) {
                ...
                if (this.href) node = CHTML.addElement(node, "a", {
                    href: this.href,
                    isMathJax: true
                });
                if (!this.CHTMLnodeID) this.CHTMLnodeID = CHTML.GetID();
                var id = (this.id || "MJXc-Node-" + this.CHTMLnodeID) + CHTML.idPostfix;
                return this.CHTMLhandleAttributes(CHTML.addElement(node, "mjx-" + this.type, {
                    id: id
                }));
            },
        ...
        MML.munderover.Augment({
            ...
            CHTMLaddOverscript: function(over, boxes, values, delta, base, stretch) {
                var BBOX = this.CHTML;
                var z1, z2, z3 = CHTML.TEX.big_op_spacing5,
                    k;
