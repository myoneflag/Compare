    ...
    var FastPreview = MathJax.Extension["fast-preview"] = {
        ...
        Config: function() {
            if (HUB.config["CHTML-preview"])
                MathJax.Hub.Config({
                    "fast-preview": HUB.config["CHTML-preview"]
                });
        ...
        postFilter: function(preview, data) {
            ...
            if (!data.math.root.toPreviewHTML) {
                ...
                queue.Push(
                    ["Require", MathJax.Ajax, "[MathJax]/jax/output/PreviewHTML/config.js"], ["Require", MathJax.Ajax, "[MathJax]/jax/output/PreviewHTML/jax.js"]
                );
