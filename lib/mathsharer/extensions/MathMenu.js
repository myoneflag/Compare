...
(function(HUB, HTML, AJAX, CALLBACK, OUTPUT) {
    ...
    var MENU = MathJax.Menu = NAV.Subclass({
        ...
        Post: function(event, parent, forceLTR) {
            ...
            var styles = (window.getComputedStyle ? window.getComputedStyle(document.body) : {
                marginLeft: "0px"
            });
    ...
    MENU.About = function(event) {
        ...
        var about = HTML.addElement(MENU.About.div, "div", {
            ...
            _(font.replace(/ /g, ""), "using " + font), ["br"],
            ["br"],
            ["span", {
                style: {
                    display: "inline-block",
    ...
    MENU.Renderer = function() {
        ...
        if (jax[0] !== CONFIG.settings.renderer) {
            var BROWSER = HUB.Browser,
                message, MESSAGE = MENU.Renderer.Messages,
                warned;
            //
            ...
            HUB.Queue(
                ["setRenderer", HUB, CONFIG.settings.renderer, "jax/mml"], ["Rerender", HUB]
            );
        }
    };
    ...
    MENU.CreateLocaleMenu = function() {
        ...
        for (var i = 0, m = locales.length; i < m; i++) {
            ...
            menu.items.push(ITEM.RADIO([locales[i], title], "locale", {
                action: MENU.Locale
            }));
        }
        //
    ...
    HUB.Register.StartupHook("End Config", function() {
        ...
        MENU.menu = MENU(
            ...
            ITEM.SUBMENU(["Settings", "Math Settings"],
                ...
                ITEM.RULE(),
                ITEM.SUBMENU(["Renderer", "Math Renderer"], {
                ...
                ITEM.SUBMENU(["FontPrefs", "Font Preference"], {
                ...
                ITEM.SUBMENU(["ContextMenu", "Contextual Menu"], {
            ...
            ITEM.SUBMENU(["Locale", "Language"], {
                    hidden: !CONFIG.showLocale,
                    ltr: true
                },
                ITEM.RADIO("en", "locale", {
                    action: MENU.Locale
                }),
                ITEM.RULE().With({
    ...
    CALLBACK.Queue(
        ...
        ["Styles", AJAX, CONFIG.styles], ["Post", HUB.Startup.signal, "MathMenu Ready"], ["loadComplete", AJAX, "[MathJax]/extensions/MathMenu.js"]
    );
